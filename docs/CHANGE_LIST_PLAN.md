...
| 2 | T20 — light mode default | 0.25d | ⬜ |
| 3 | T6 — disclaimer → expandable (log sheet stays pinned) | 0.5d | ⬜ |
| 4 | T14 — fertile-window notification | 1.5d | ⬜ |
...
Green baseline is **125 domain + 139 app tests**. Run after every task:
